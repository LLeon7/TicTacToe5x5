...
class Point {   //X and Y coordinates of position
    int x, y;
...
class Board5x5 {      //5X5 BOARD
    ...
    public boolean hasXWon() {
        if ((board[0][0] == board[1][1] && board[0][0] == board[2][2]
                ...
                && board[0][0] == 1)
                || (board[0][4] == board[1][3] && board[0][4] == board[2][2]
    ...
    public List<Point> getAvailablePoints() {   //Creates a list with the unexpanded nodes
    ...
    public int getState(Point point){
        /*
        Returns 0 if current position is blank
        Returns 1 if X is there
        returns 2 if O is there
         */
